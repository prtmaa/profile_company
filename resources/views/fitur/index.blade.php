            ...
            <div class="col-md-12">
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <button onclick="addForm('{{ route('fitur.store') }}')" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data</button>
                </div>
...
@push('js')
    <script>
       ...
       function addForm(url) {
            ...
            $('#modal-form .modal-title').text('Tambah Fitur');
       ...
       function editForm(url) {
            $('#modal-form').modal('show');
            $('#modal-form .modal-title').text('Edit Fitur');
            $('#modal-form form')[0].reset();
            $('#modal-form form').attr('action', url);
